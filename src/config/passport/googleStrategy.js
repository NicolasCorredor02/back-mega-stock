...
const strategyConfig = {
  ...
  callbackURL: 'http://localhost:8080/api/clients/user/login/auth/google/callback',
  passReqToCallback: true
}

const registerOrLogin = async (req, accessToken, refreshToke, profile, done) => {
  try {
    ...
    const userData = {
      body: {
        ...
        phone: ' ',
        id_number: parseInt(profile._json.sub)
      },
